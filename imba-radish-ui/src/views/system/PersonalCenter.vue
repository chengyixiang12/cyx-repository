          ...
          <div class="avatar-section">
            ...
            <div class="avatar-upload">
              ...
              <el-button 
                ...
                size="small" 
                @click="removeAvatar"
                :disabled="!profileForm.avatar || profileForm.avatar.includes('default')"
              >
          ...
          <el-tabs v-model="activeTab" class="profile-tabs">
            <el-tab-pane label="基本信息" name="basic">
              ...
              >
                ...
                <el-form-item>
                  <el-button type="primary" @click="updateProfile(basicFormRef)">
                    保存信息
                  </el-button>
...
import { getUserInfoApi, updateUserApi, updatePasswordApi } from '@/api/user'
...
// 用户信息表单
const profileForm = reactive<GetUserVo>({
  id: '',
  nickname: null,
  email: null,
  phone: null,
...
const handleAvatarSuccess: UploadProps['onSuccess'] = (response) => {
  if (response.code === 200) {
    profileForm.avatar = avatar_url + '/' + response.data
...
const getUserInfo = async () => {
  try {
    ...
    if (res.code === 200) {
      ...
      profileForm.avatar = res.data.avatar ? avatar_url + '/' + res.data.avatar : ''
    }
  } catch (error) {
